...
add_action( 'hnmg_init', 'my_theme_options');
function my_theme_options(){
	$options = array(
		'id' => 'my-theme-options',
		'title' => 'Theme Options',
		'menu_title' => 'Xbox Admin Page',
		'icon' => HNMGBOX_URL.'img/hnmgbox-light-small.png',//Menu icon
	...
	$hnmgbox = hnmgbox_new_admin_page( $options );
	...
	$hnmgbox->add_main_tab( array(
		...
		'items' => array(
			...
			'date-time' => '<i class="hnmgbox-icon hnmgbox-icon-check-square"></i>Date - Time',
			...
			'import' => '<i class="hnmgbox-icon hnmgbox-icon-database"></i>Import/Export',
		),
	));
		...
		$hnmgbox->open_tab_item('logo');
			...
			$hnmgbox->open_tab_item('main-logo');
                ...
                $hnmgbox->open_mixed_field(array('name' => 'Use text logo'));
                    $hnmgbox->add_field(array(
                        'name' => 'Enabled',
                        'id' => 'use-text-logo',
                        'type' => 'switcher',
		...
		$hnmgbox->open_tab_item('header');
			$section_header_1 = $hnmgbox->add_section( array(
				...
				$section_header_1->add_field(array(
					...
					'desc' => '"grid" => "3-of-8"',
					'options' => array(
						'helper' => '<i class="hnmgbox-icon hnmgbox-icon-envelope-o"></i> @gmail.com'
					),
				));
				$section_header_1->add_field(array(
					'name' => 'Address',
					...
					'desc' => '"grid" => "4-of-8"',
					'options' => array(
						'helper' => '<i class="hnmgbox-icon hnmgbox-icon-address-card"></i>'
					),
				));
...
',
		...
		$hnmgbox->open_tab_item('date-time');
			$hnmgbox->add_field( array(
				'id' => 'my-date',
				'name' => 'Date',
				'type' => 'date',
		...
		$hnmgbox->close_tab_item('date-time');
		...
		$hnmgbox->open_tab_item('import');
			$hnmgbox->add_import_field(array(
				'name' => 'Select Demo',
				'default' => 'http://hnmgboxframework.com/demos/demo3.json',
				'desc' => 'Choose a demo, then click import button',
				'items' => array(
					'http://hnmgboxframework.com/demos/demo1.json' => HNMGBOX_URL.'example/img/demo1.png',
					'http://hnmgboxframework.com/demos/demo2.json' => HNMGBOX_URL.'example/img/demo2.png',
					'http://hnmgboxframework.com/demos/demo3.json' => HNMGBOX_URL.'example/img/demo3.png'
				),
				'options' => array(
			...
			$hnmgbox->add_export_field(array(
				'name' => 'Export',
				'desc' => 'Download and make a backup of your options.',
			));
		$hnmgbox->close_tab_item('import');
