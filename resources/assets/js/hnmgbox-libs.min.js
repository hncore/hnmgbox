...
! function(a) {
	...
	var b, c, d = function(b, c) {
		return this.$el = b, this.options = a.extend({}, d.rules.defaults, d.rules[c.rule] || {}, c), this.min = Number(this.options.min) || 0, this.max = Number(this.options.max) || 0, this.$el.on({
			"focus.spinnerNum": a.proxy(function(b) {
				b.preventDefault(), a(document).trigger("mouseup.spinnerNum"), this.oldValue = this.value()
			}, this),
			"change.spinnerNum": a.proxy(function(a) {
				a.preventDefault(), this.value(this.$el.val())
			}, this),
			"keydown.spinnerNum": a.proxy(function(a) {
				var b = {
					38: "up",
					40: "down"
				} [a.which];
	...
	d.rules = {
		...
		spin: function(b) {
			if (!this.$el.prop("disabled")) {
				...
				var c = typeof this.options.step === "function" ? this.options.step.call(this, b) : this.options.step, d = b === "up" ? 1 : -1;
		...
		value: function(d) {
			...
			0 !== e && (d = e === -1 ? this.min : this.max), this.$el.val(d.toFixed(this.options.precision)), this.oldValue !== this.value() && (this.$el.trigger("changing.spinnerNum", [this.value(), this.oldValue]), clearTimeout(b), b = setTimeout(a.proxy(function() {
				this.$el.trigger("changed.spinnerNum", [this.value(), this.oldValue])
			}, this), c.delay))
		},
		numeric: function(a) {
		...
		this.$el = a(b), this.$spinning = this.$el.find('[data-spin="spinnerNum"]'), 0 === this.$spinning.length && (this.$spinning = this.$el.find(':input[type="text"]')), c = a.extend({}, c, this.$spinning.data()), this.spinning = new d(this.$spinning, c), this.$el.on("click.spinnerNum", '[data-spin="up"], [data-spin="down"]', a.proxy(this, "spin")).on("mousedown.spinnerNum", '[data-spin="up"], [data-spin="down"]', a.proxy(this, "spin")), a(document).on("mouseup.spinnerNum", a.proxy(function() {
		...
		changed: function(a) {
			this.bindHandler("changed.spinnerNum", a)
		},
		changing: function(a) {
			this.bindHandler("changing.spinnerNum", a)
		},
		bindHandler: function(b, c) {
			typeof c === 'function' ? this.$spinning.on(b, c) : this.$spinning.off(b);
		},
		beginSpin: function(b) {
			this.spinInterval = setInterval(a.proxy(this.spinning, "spin", b), 100)
		}
	};
	var e = a.fn.spinnerNum;
	return a.fn.spinnerNum = function(b, d) {
		return this.each(function() {
			var e = a.data(this, "spinnerNum");
			e || (e = new c(this, b), a.data(this, "spinnerNum", e)), "delay" === b || "changed" === b || "changing" === b ? e[b](d) : "step" === b && d ? e.spinning.step = d : "spin" === b && d && e.spinning.spin(d)
		})
	}, a.fn.spinnerNum.Constructor = c, a.fn.spinnerNum.noConflict = function() {
		return a.fn.spinnerNum = e, this
	}, a(function() {
		a('[data-trigger="spinnerNum"]').spinnerNum()
	}), a.fn.spinnerNum
});;
...
function(a, b) {
	...
	function i() {
		return b("head").append('<style type="text/css" id="tinyColorPickerStyles">' + (r.css || I) + (r.cssAddon || "") + "</style>"), b(H).css({
			margin: r.margin
...
! function(e, t, n, i) {
	"use strict";
	t = void 0 !== t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.dropdownHnmgbox = function(a) {
		var o, s = e(this),
			r = e(n),
			l = s.selector || "",
		...
		return s.each(function(h) {
			var g, p, b, w, x, C, S, y, A = e.isPlainObject(a) ? e.extend(!0, {}, e.fn.dropdownHnmgbox.settings, a) : e.extend({}, e.fn.dropdownHnmgbox.settings),
				T = A.className,
				k = A.message,
				L = A.fields,
				I = A.keys,
			...
			y = {
				...
				observe: {
					select: function() {
						y.has.input() && C.observe(z[0], {
							childList: !0,
							subtree: !0
						})
					},
					menu: function() {
						y.has.menu() && S.observe(B[0], {
							childList: !0,
							subtree: !0
						})
					}
				...
				create: {
					...
					userChoice: function(t) {
						var n, a, o;
						return !!(t = t || y.get.userValues()) && (t = Array.isArray(t) ? t : [t], e.each(t, function(t, s) {
				...
				select: {
					...
					nextAvailable: function(e) {
						...
						t.length > 0 ? (y.verbose("Moving selection to", t), t.addClass(T.selected)) : (y.verbose("Moving selection to", n), n.addClass(T.selected))
					}
				},
				setup: {
					api: function() {
					...
					select: function() {
						...
						y.debug("Dropdown initialized on a select", t), z.is("select") && (U = z), U.parent(O.dropdownHnmgbox).length > 0 ? (y.debug("UI dropdown already exists. Creating dropdown menu only"), z = U.closest(O.dropdownHnmgbox), y.has.menu() || y.create.menu(), B = z.children(O.menu), y.setup.menu(t)) : (y.debug("Creating entire dropdown from select"), z = e("<div />").attr("class", U.attr("class")).addClass(T.selection).addClass(T.dropdownHnmgbox).html(E.dropdownHnmgbox(t)).insertBefore(U), U.hasClass(T.multiple) && !1 === U.prop("multiple") && (y.error(V.missingMultiple), U.prop("multiple", !0)), U.is("[multiple]") && y.set.multiple(), U.prop("disabled") && (y.debug("Disabling dropdown"), z.addClass(T.disabled)), U.removeAttr("class").detach().prependTo(z)), y.refresh()
					},
					menu: function(e) {
						B.html(E.menu(e, L)), $ = B.find(O.item)
					},
					reference: function() {
						y.debug("Dropdown behavior was called on select, replacing with closest dropdown"), z = z.parent(O.dropdownHnmgbox), J = z.data(F), G = z.get(0), y.refresh(), y.setup.returnedObject()
					},
				...
				show: function(t) {
					if (t = typeof t === "function" ? t : function() {}, !y.can.show() && y.is.remote() && (y.debug("No API results retrieved, searching before show"), y.queryRemote(y.get.query(), y.show)), y.can.show() && !y.is.active()) {
						...
						!1 !== A.onShow.call(G) && y.animate.show(function() {
							y.can.click() && y.bind.intent(), y.has.menuSearch() && y.focusSearch(), y.set.visible(), t.call(G)
						})
					}
				},
				hide: function(t) {
					t = typeof t === "function" ? t : function() {}, y.is.active() && !y.is.animatingOutward() && (y.debug("Hiding dropdown"), !1 !== A.onHide.call(G) && y.animate.hide(function() {
						y.remove.visible(), t.call(G)
					}))
				},
				hideOthers: function() {
					y.verbose("Finding other dropdowns to hide"), s.not(z).has(O.menu + "." + T.visible).dropdownHnmgbox("hide")
				},
				hideMenu: function() {
				...
				filterItems: function(t) {
					...
					y.has.query() && (a = [], y.verbose("Searching for matching values", n), $.each(function() {
						...
						if ("both" == A.match || "text" == A.match) {
							if (-1 !== (t = String(y.get.choiceText(o, !1))).search(s)) return a.push(this), !0;
							if ("exact" === A.fullTextSearch && y.exactSearch(n, t)) return a.push(this), !0;
							if (!0 === A.fullTextSearch && y.fuzzySearch(n, t)) return a.push(this), !0
						}
						if ("both" == A.match || "value" == A.match) {
							if (-1 !== (i = String(y.get.choiceValue(o, t))).search(s)) return a.push(this), !0;
							if ("exact" === A.fullTextSearch && y.exactSearch(n, i)) return a.push(this), !0;
							if (!0 === A.fullTextSearch && y.fuzzySearch(n, i)) return a.push(this), !0
						}
				...
				focusSearch: function(e) {
					if (y.has.search() && !y.is.focusedOnSearch()) {
						if (e) {
							z.off("focus" + M, O.search);
							j.trigger("focus");
							z.on("focus" + M, O.search, y.event.search.focus);
						} else {
							j.trigger("focus");
						}
					}
				...
				forceSelection: function() {
					var e = $.not(T.filtered).filter("." + T.selected).eq(0),
						...
						n = e.length > 0 ? e : t;
					if (n.length > 0 && !y.is.multiple()) return y.debug("Forcing partial selection to selected item", n), void y.event.item.click.call(n, {}, !0);
					A.allowAdditions ? (y.set.selected(y.get.query()), y.remove.searchTerm()) : y.remove.searchTerm()
				},
				change: {
					values: function(t) {
						A.allowAdditions || y.clear(), y.debug("Creating dropdown with specified values", t), y.setup.menu({
							values: t
				...
				event: {
					...
					item: {
						mouseenter: function(t) {
							var n = e(t.target),
								...
								s = a.length > 0;
							!(a.find(n).length > 0) && s && (clearTimeout(y.itemTimer), y.itemTimer = setTimeout(function() {
						...
						click: function(t, i) {
							var a = e(this),
								...
								c = s.length > 0,
								u = s.find(o).length > 0;
							y.has.menuSearch() && e(n.activeElement).blur(), u || c && !A.allowCategorySelection || (y.is.searchSelection() && (A.allowAdditions && y.remove.userAddition(), y.remove.searchTerm(), y.is.focusedOnSearch() || 1 == i || y.focusSearch(!0)), A.useLabels || (y.remove.filteredItem(), y.set.scrollPosition(a)), y.determine.selectAction.call(this, r, l))
						}
					},
					document: {
						keydown: function(e) {
					...
					keydown: function(e) {
						var t = e.which;
						if (y.is.inObject(t, I)) {
							var n, i = $.not(O.unselectable).filter("." + T.selected).eq(0),
							...
							if (A.allowAdditions && A.hideAdditions && (t == I.enter || f) && v && (y.verbose("Selecting item from keyboard shortcut", o), y.event.item.click.call(o, e), y.is.searchSelection() && y.remove.searchTerm()), y.is.visible()) {
								if ((t == I.enter || f) && (t == I.enter && d && u && !A.allowCategorySelection ? (y.verbose("Pressed enter on unselectable category, opening sub menu"), t = I.rightArrow) : v && (y.verbose("Selecting item from keyboard shortcut", o), y.event.item.click.call(o, e), y.is.searchSelection() && y.remove.searchTerm()), e.preventDefault()), d && (t == I.leftArrow && l[0] !== B[0] && (y.verbose("Left key pressed, closing sub-menu"), y.animate.hide(!1, l), o.removeClass(T.selected), l.closest(O.item).addClass(T.selected), e.preventDefault()), t == I.rightArrow && u && (y.verbose("Right key pressed, opening sub-menu"), y.animate.show(!1, r), o.removeClass(T.selected), r.find(O.item).eq(0).addClass(T.selected), e.preventDefault())), t == I.upArrow) {
									if (n = d && c ? o.prevAll(O.item + ":not(" + O.unselectable + ")").eq(0) : $.eq(0), s.index(n) < 0) return y.verbose("Up key pressed but reached top of current menu"), void e.preventDefault();
									y.verbose("Up key pressed, changing active item"), o.removeClass(T.selected), n.addClass(T.selected), y.set.scrollPosition(n), A.selectOnKeydown && y.is.single() && y.set.selectedItem(n), e.preventDefault()
								}
								if (t == I.downArrow) {
									if (0 === (n = d && c ? n = o.nextAll(O.item + ":not(" + O.unselectable + ")").eq(0) : $.eq(0)).length) return y.verbose("Down key pressed but reached bottom of current menu"), void e.preventDefault();
									y.verbose("Down key pressed, changing active item"), $.removeClass(T.selected), n.addClass(T.selected), y.set.scrollPosition(n), A.selectOnKeydown && y.is.single() && y.set.selectedItem(n), e.preventDefault()
								}
				...
				determine: {
					selectAction: function(t, n) {
						y.verbose("Determining action", A.action), typeof y.action[A.action] === "function"
						? (y.verbose("Triggering preset action", A.action, t, n), y.action[A.action].call(G, t, n, this)) : typeof A.action === "function"
						? (y.verbose("Triggering user action", A.action, t, n), A.action.call(G, t, n, this)) : y.error(V.action, A.action)
					},
					eventInModule: function(t, i) {
						var a = e(t.target),
							o = a.closest(n.documentElement).length > 0,
							s = a.closest(z).length > 0;
						return i = typeof i === "function" ? i : function() {}, o && !s ? (y.verbose("Triggering event", i), i(), !0) : (y.verbose("Event occurred in dropdown, canceling callback"), !1)
					},
					eventOnElement: function(t, i) {
						...
						return i = typeof i === "function" ? i : function() {}, s && r && l ? (y.verbose("Triggering event", i), i(), !0) : (y.verbose("Event occurred in dropdown menu, canceling callback"), !1)
					}
				},
				action: {
					nothing: function() {},
					...
					select: function(t, n, a) {
						if (n = n !== i ? n : t, y.can.activate(e(a))) {
							if (y.set.value(n, t, e(a)), y.is.multiple() && !y.is.allFiltered()) return;
							y.hideAndClear()
						}
					},
				...
				get: {
					...
					selectionCount: function() {
						var t = y.get.values();
						return y.is.multiple() ? Array.isArray(t) ? t.length : 0 : "" !== y.get.value() ? 1 : 0
					},
					...
					value: function() {
						var t = U.length > 0 ? U.val() : z.data(D.value),
							n = Array.isArray(t) && 1 === t.length && "" === t[0];
						return t === i || n ? "" : t
					},
					values: function() {
						var e = y.get.value();
					...
					choiceText: function(t, n) {
						if (n = n !== i ? n : A.preserveHTML, t) return t.find(O.menu).length > 0 && (y.verbose("Retrieving text of element with sub-menu"), (t = t.clone()).find(O.menu).remove(), t.find(O.menuIcon).remove()), t.data(D.text) !== i ? t.data(D.text) : n ? t.html().trim() : t.text().trim()
					},
					choiceValue: function(t, n) {
						n = n || y.get.choiceText(t);
						return !!t && (t.data(D.value) !== i ? String(t.data(D.value)) : typeof n === "string" ? n.toLowerCase().trim() : String(n));
					},					
					inputEvent: function() {
						var e = j[0];
					...
					selectValues: function() {
						...
						return z.find("option").each(function() {
							var n = e(this),
								a = n.html(),
								o = n.attr("disabled"),
					...
					item: function(t, n) {
						var a, o, s = !1;
						return t = t !== i ? t : y.get.values() !== i ? y.get.values() : y.get.text(), a = o ? t.length > 0 : t !== i && null !== t, o = y.is.multiple() && Array.isArray(t), n = "" === t || 0 === t || (n || !1), a && $.each(function() {
							var a = e(this),
								r = y.get.choiceText(a),
								l = y.get.choiceValue(a, r);
							if (null !== l && l !== i)
				...
				restore: {
					...
					defaultText: function() {
						...
						e === y.get.placeholderText ? (y.debug("Restoring default placeholder text", e), y.set.placeholderText(e)) : (y.debug("Restoring default text", e), y.set.text(e))
					},
					placeholderText: function() {
				...
				save: {
					...
					placeholderText: function() {
						var e;
						!1 !== A.placeholder && H.hasClass(T.placeholder) && (e = y.get.text(), y.verbose("Saving placeholder text as", e), z.data(D.placeholderText, e))
					},
				...
				scrollPage: function(e, t) {
					var n, i, a = t || y.get.selectedItem(),
						o = a.closest(O.menu),
						s = o.outerHeight(),
						r = o.scrollTop(),
						l = $.eq(0).outerHeight(),
					...
					i = "up" == e ? d.index(a) - c : d.index(a) + c, (n = ("up" == e ? i >= 0 : i < d.length) ? d.eq(i) : "up" == e ? d.first() : d.last()).length > 0 && (y.debug("Scrolling page", e, n), a.removeClass(T.selected), n.addClass(T.selected), A.selectOnKeydown && y.is.single() && y.set.selectedItem(n), o.scrollTop(u))
				},
				set: {
					filtered: function() {
						var e = y.is.multiple(),
					...
					scrollPosition: function(e, t) {
						var n, a, o, s, r, l;
						n = (e = e || y.get.selectedItem()).closest(O.menu), a = e && e.length > 0, t = t !== i && t, e && n.length > 0 && a && (e.position().top, n.addClass(T.loading), o = (s = n.scrollTop()) - n.offset().top + e.offset().top, t || (l = s + n.height() < o + 5, r = o - 5 < s), y.debug("Scrolling to active item", o), (t || r || l) && n.scrollTop(o), n.removeClass(T.loading))
					},
					text: function(e) {
					...
					selectedItem: function(e) {
						...
						y.debug("Setting user selection to item", e), y.remove.activeItem(), y.set.partialSearch(n), y.set.activeItem(e), y.set.selected(t, e), y.set.text(i)
					},
					selectedLetter: function(t) {
						var n, i = $.filter("." + T.selected),
							a = !1;
						i.length > 0 && y.has.firstLetter(i, t) && (n = i.nextAll($).eq(0), y.has.firstLetter(n, t) && (a = n)), a || $.each(function() {
					...
					value: function(e, t, n) {
						...
						if (o) {
							...
							y.is.single() && y.has.selectInput() && y.can.extendSelect() && (y.debug("Adding user option", e), y.add.optionValue(e)), y.debug("Updating input value", a, s), Y = !0, U.val(a), !1 === A.fireOnInit && y.is.initialLoad() ? y.debug("Input native change event ignored on initial load") : y.trigger.change(), Y = !1
						} else y.verbose("Storing value in metadata", a, U), a !== s && z.data(D.value, r);
						!1 === A.fireOnInit && y.is.initialLoad() ? y.verbose("No callback on initial load", A.onChange) : A.onChange.call(G, e, t, n)
					},
					active: function() {
						z.addClass(T.active)
					},
					...
					selected: function(t, n) {
						var i = y.is.multiple();
						(n = A.allowAdditions ? n || y.get.itemWithAdditions(t) : n || y.get.item(t)) && (y.debug("Setting selected menu item to", n), y.is.multiple() && y.remove.searchWidth(), y.is.single() ? (y.remove.activeItem(), y.remove.selectedItem()) : A.useLabels && y.remove.selectedItem(), n.each(function() {
							var t = e(this),
				...
				add: {
					...
					optionValue: function(t) {
						...
						U.find('option[value="' + y.escape.string(n) + '"]').length > 0 || (y.disconnect.selectObserver(), y.is.single() && (y.verbose("Removing previous user addition"), U.find("option." + T.addition).remove()), e("<option/>").prop("value", n).addClass(T.addition).html(t).appendTo(U), y.verbose("Adding user addition as an <option>", t), y.observe.select())
					},
					userSuggestion: function(e) {
						var t, n = B.children(O.addition),
							...
							o = n.length > 0;
						A.useLabels && y.has.maxSelections() || ("" === e || a ? n.remove() : (o ? (n.data(D.value, e).data(D.text, e).attr("data-" + D.value, e).attr("data-" + D.text, e).removeClass(T.filtered), A.hideAdditions || (t = A.templates.addition(y.add.variables(k.addResult, e)), n.html(t)), y.verbose("Replacing user suggestion with new value", n)) : ((n = y.create.userChoice(e)).prependTo(B), y.verbose("Adding item choice to menu corresponding with user choice addition", n)), A.hideAdditions && !y.is.allFiltered() || n.addClass(T.selected).siblings().removeClass(T.selected), y.refreshItems()))
					},
				...
				remove: {
					...
					optionValue: function(e) {
						...
						n.length > 0 && n.hasClass(T.addition) && (C && (C.disconnect(), y.verbose("Temporarily disconnecting mutation observer")), n.remove(), y.verbose("Removing user addition as an <option>", t), C && C.observe(U[0], {
							childList: !0,
							subtree: !0
						}))
					},
					...
					selected: function(t, n) {
						if (!(n = A.allowAdditions ? n || y.get.itemWithAdditions(t) : n || y.get.item(t))) return !1;
						n.each(function() {
							var t = e(this),
					...
					label: function(e, t) {
						var n = z.find(O.label).filter("[data-" + D.value + '="' + y.escape.string(e) + '"]');
					...
					labels: function(t) {
						t = t || z.find(O.label), y.verbose("Removing labels", t), t.each(function() {
							var t = e(this),
								...
								a = n !== i ? String(n) : n,
								o = y.is.userValue(a);
							!1 !== A.onLabelRemove.call(t, n) ? (y.remove.message(), o ? (y.remove.value(a), y.remove.label(a)) : y.remove.selected(a)) : y.debug("Label remove callback cancelled removal")
						})
					},
					tabbable: function() {
				...
				has: {
					...
					firstLetter: function(e, t) {
						var n;
						return !(!e || 0 === e.length || "string" != typeof t) && (n = y.get.choiceText(e, !1), (t = t.toLowerCase()) == String(n).charAt(0).toLowerCase())
					},
					input: function() {
						return U.length > 0
					},
					...
					label: function(e) {
						var t = y.escape.value(e),
							n = z.find(O.label);
						return A.ignoreCase && (t = t.toLowerCase()), n.filter("[data-" + D.value + '="' + y.escape.string(t) + '"]').length > 0
					},
				...
				is: {
					...
					alreadySetup: function() {
						return z.is("select") && z.parent(O.dropdownHnmgbox).data(F) !== i && 0 === z.prev().length
					},
					...
					searchSelection: function() {
						return y.has.search() && 1 === j.parent(O.dropdownHnmgbox).length
					},
					selection: function() {
				...
				can: {
					...
					openDownward: function(e) {
						...
						}, y.is.verticallyScrollableContext() && (i.menu.offset.top += i.context.scrollTop), (n = {
						...
						}).below ? (y.verbose("Dropdown can fit in context downward", n), o = !0) : n.below || n.above ? (y.verbose("Dropdown cannot fit below, opening upward", n), o = !1) : (y.verbose("Dropdown cannot fit in either direction, favoring downward", n), o = !0), a.removeClass(T.loading), o
					},
					openRightward: function(e) {
						...
						}, y.is.horizontallyScrollableContext() && (i.menu.offset.left += i.context.scrollLeft), (n = i.menu.offset.left - i.context.offset.left + i.menu.width >= i.context.scrollLeft + i.context.width) && (y.verbose("Dropdown cannot fit in context rightward", n), o = !1), a.removeClass(T.loading), o
					},
					click: function() {
						return c || "click" == A.on
					},
				...
				animate: {
					show: function(t, n) {
						...
						t = typeof t === "function" ? t : function() {}, y.verbose("Doing menu show animation", o), y.set.direction(n), a = y.get.transition(n), y.is.selection() && y.set.scrollPosition(y.get.selectedItem(), !0), (y.is.hidden(o) || y.is.animating(o)) && ("none" == a ? (s(), o.transition("show"), t.call(G)) : e.fn.transition !== i && z.transition("is supported") ? o.transition({
							animation: a + " in",
							debug: A.debug,
							verbose: A.verbose,
							duration: A.duration,
					...
					hide: function(t, n) {
						...
						t = typeof t === "function" ? t : function() {}, (y.is.visible(a) || y.is.animating(a)) && (y.verbose("Doing menu hide animation", a), "none" == s ? (o(), a.transition("hide"), t.call(G)) : e.fn.transition !== i && z.transition("is supported") ? a.transition({
							animation: s + " out",
							duration: A.duration,
							debug: A.debug,
							verbose: A.verbose,
				...
				escape: {
					value: function(t) {
						var n = Array.isArray(t),
							...
							s = [];
						return a || !o ? t : (y.debug("Encoding quote values for use in select", t), n ? (e.each(t, function(e, t) {
				...
				performance: {
					log: function(e) {
						var t, n;
						A.performance && (n = (t = (new Date).getTime()) - (u || t), u = t, d.push({
							Name: e[0],
				...
				invoke: function(t, n, a) {
					var s, r, l, c = J;
					return n = n || m, a = G || a, "string" == typeof t && c !== i && (t = t.split(/[\. ]/), s = t.length - 1, e.each(t, function(n, a) {
					...
					})), typeof r === "function" ? l = r.apply(a, n) : r !== i && (l = r), Array.isArray(o) ? o.push(l) : o !== i ? o = [o, l] : l !== i && (o = l), r
				}
			}, f ? (J === i && y.initialize(), y.invoke(v)) : (J !== i && J.invoke("destroy"), y.initialize())
		}), o !== i ? o : s
	}, e.fn.dropdownHnmgbox.settings = {
		silent: !1,
		debug: !1,
		verbose: !1,
		performance: !0,
	...
	}, e.fn.dropdownHnmgbox.settings.templates = {
		dropdownHnmgbox: function(t) {
		...
		return o.each(function(e) {
			...
			C = {
				...
				invoke: function(e, i, o) {
					...
					})), typeof s === "function" ? l = s.apply(o, i) : s !== t && (l = s), Array.isArray(a) ? a.push(l) : a !== t ? a = [a, l] : l !== t && (a = l), s !== t && s
				}
			}, C.initialize()
		}), a !== t ? a : this
	...
	t.extend(o.prototype, {
		...
		show: function() {
			var o = this.tooltip(),
				e = this,
				r = this.win;
			e.settings.showArrow === !1 ? o.find(".tipso_arrow").hide() : o.find(".tipso_arrow").show(), "hide" === e.mode && (typeof e.settings.onBeforeShow === "function" && e.settings.onBeforeShow(e.$element, e.element, e), e.settings.size && o.addClass(e.settings.size), e.settings.width ? o.css({
				...
				e.ieFade || "" === e.settings.animationIn || "" === e.settings.animationOut ? o.appendTo("body").stop(!0, !0).fadeIn(e.settings.speed, function() {
					e.mode = "show", typeof e.settings.onShow === "function" && e.settings.onShow(e.$element, e.element, e)
					...
					}), e.mode = "show", typeof e.settings.onShow === "function" && e.settings.onShow(e.$element, e.element, e), r.off("resize." + i, null, "tipsoResizeHandler")
				})
			}, e.settings.delay))
		},
		hide: function(o) {
			...
			o && (n = 0, e.mode = "show"), window.clearTimeout(e.timeout), e.timeout = null, e.timeout = window.setTimeout(function() {
				"tooltipHover" !== e.mode && (e.ieFade || "" === e.settings.animationIn || "" === e.settings.animationOut ? s.stop(!0, !0).fadeOut(e.settings.speed, function() {
					t(this).remove(), typeof e.settings.onHide === "function" && "show" === e.mode && e.settings.onHide(e.$element, e.element, e), e.mode = "hide", r.off("resize." + i, null, "tipsoResizeHandler")
					...
					t(this).removeClass("animated " + e.settings.animationOut).remove(), typeof e.settings.onHide === "function" && "show" === e.mode && e.settings.onHide(e.$element, e.element, e), e.mode = "hide", r.off("resize." + i, null, "tipsoResizeHandler")
				}))
			}, n)
		},
		close: function() {
...
(function($, window, document, undefined) {
	...
	Plugin.prototype = {
		...
		ajax_content: function() {
			...
			$.ajax({
				...
				success: function(response) {
					...
					if (typeof _.options.content.onSuccess === "function") {
		...
		open: function() {
			...
			_.visible = true;
			_.center();
			if (typeof _.options.onOpen === "function") {
		...
		close: function(event, confirm) {
			...
			_.$el.one("webkitAnimationEnd oanimationend msAnimationEnd animationend", function(event) {
				if (typeof _.options.onCancel === "function" && confirm === false) {
					_.options.onCancel.call(this);
				}
				if (typeof _.options.onConfirm === "function" && confirm) {
					_.options.onConfirm.call(this);
				}
				if (typeof _.options.onClose === "function") {
