...
;(function ( $, window, document, undefined ) {
  ...
  Plugin.prototype = {
    init : function () {
      var _ = this;
      if( _.$el.hasClass('hnmgbox-image-selector') ){
        return;
      }
      _.build();
      return _;
    ...
    build: function () {
      var _ = this;
      _.$el.addClass('hnmgbox-image-selector');
    ...
    active : function(){
      var $input = $(this);
      var $el = $input.closest('.hnmgbox-image-selector');
    ...
    destroy: function () {
      $(this).each(function() {
        $(this).removeClass('hnmgbox-image-selector').find('img').remove();
      });
      return true;
    },
  ...
  $(document).ready(function($) {
    $(document).on('click.img_selector', '.hnmgbox-image-selector input', function(event) {
      $(this).hnmgboxImageSelector('active');
    });
    $(document).on('img_selector_disable_all', '.hnmgbox-image-selector input', function(event) {
      $(this).hnmgboxImageSelector('disable_all');
    });
  });

  $.fn.hnmgboxImageSelector = function ( options ) {
